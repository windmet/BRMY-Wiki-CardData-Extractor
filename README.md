...
这是一个专为 coly 旗下手游《Break My Case》（ブレイクマイケース）Wiki 组编辑人员制作的卡牌数据一键解析与格式化游戏卡牌数据的辅助工具。
用时好几天，懵懵懂懂的，靠gemini老师debug了几十轮终于得到比较好的成果。
为适应后续可能的格式改变以及项目维护，遂在此分享源码，希望能帮助到wiki组的建设~
...
## 关于《Break My Case》数据解析辅助工具的免责声明 (Disclaimer)
